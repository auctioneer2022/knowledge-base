...
本项目是基于 MkDocs Material 构建的静态文档站点，采用 Markdown + YAML Front Matter 作为内容载体，通过 GitHub Actions 实现自动化构建与部署。知识库覆盖法律法规、会计准则、审计准则、税法法规、行业知识、实务模板、案例库、工具方法、培训资源九大知识域，当前已收录194项知识条目，整体完成率92.8%。
