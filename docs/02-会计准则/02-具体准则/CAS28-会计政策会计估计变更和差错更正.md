...
status: 现行有效
keywords: [会计政策变更, 会计估计变更, 差错更正, 追溯调整]
---

# 企业会计准则第28号——会计政策、会计估计变更和差错更正

第一条 为了规范企业会计政策的应用
会计估计变更和前期差错更正的确认、计量和相关信息的披露，根据《企业会计准则——基本准则》，制定本准则。
...
第四条 企业采用的会计政策，在每一会计期间和前后各期应当保持一致，不得随意变更
...
及
以后发生的交易或者事项，或者在会计估计变更当期和未来期间确认会计估计变更影响数的方法。

## 第三章 会计估计变更

第八条 企业
以进行估计的基础发生了变化，或者由于取得新信息、积累更多经验以及后来的发展变化，可能需要对会计估计进行修订。会计估计变更的依据应当真实、可靠。
...
会计政策变更
或
会计估计变更的，应当将其作为会计估计变更处理。

## 第四章 前期差错更正

第十一条 前期差错，是指由于没有运用或错误运用下
两种信息，而对前期财务报表造成
省略
或
错
